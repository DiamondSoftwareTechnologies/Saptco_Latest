...
function GetPassengerItemHTML(index, itemType, isCompleted,Name)
{
    ...
    return '<li style="border-bottom: 1px solid #EFEDC3;"><div class="row  no-gutter PassengerItemClickable" style="padding-left:5px; padding-right : 5px; padding-top: 5px ;" data-type="' + itemType + '" data-index="' + index + '"  >                     ' +
             '      <div class="col-5"  >                                                                        ' +
