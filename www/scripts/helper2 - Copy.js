...
function fillAdultsList(array)
{
    var adult_list = myApp.virtualList('.adult-list', {
        ...
        renderItem: function (index, item)
        {
            ...
            return '<div class="row  no-gutter" style="padding-left:5px; padding-right : 5px; padding-top: 5px ;">                     ' +
              '      <div class="col-5" >                                                                        ' +
              '          <img src="' + imgSrc + '" style="width: 15px;  margin: 25%;padding-top: 5px;"/>            ' +
              '      </div>                                                                                      ' +

              '<div class="adult-text col-50 passenger_name add-passenger-details" style="font-weight: 300; font-size: 16px !important; font-stretch: condensed; line-height: 35px;"  data-type="adult" data-index="' + index + '" >' + item.Name +
              '</div>                                                                                      ' +
                '          <img src="' + imgSrc2 + '" class="add-passenger-details" data-type="adult" data-index="' + index + '" style="width: 32px;" />' +
              '      <div class="col-10">                                                                        ' +
              '          <img src="img/users-icons.svg" class="go-to-fav"  data-type="adult" data-index="' + index + '" style="width: 32px;"/>                                                          ' +
              '      </div>                                                                                      ' +

                     '      <div class="col-10 ">                                                                       ' +
                  '          <img src="img/search-icons.svg" class="search-passenger-details" data-type="adult" data-index="' + index + '" style="width: 32px;"/>                                                            ' +
              '      </div>                                                                                      ' +
              '  </div> ';
        }
    });
        ...
        renderItem: function (index, item)
        {
            ...
            return '<div class="row  no-gutter" style="padding-left:5px; padding-right : 5px; padding-top: 5px ;">                     ' +
              '      <div class="col-5"  >                                                                        ' +
                  '          <img src="' + imgSrc + '"  style="width: 15px; margin: 25%;padding-top: 5px;"/>                                                     ' +
              '      </div>                                                                                      ' +
                  '      <div class="adult-text col-50  passenger_name add-passenger-details" style="font-weight: 300; font-size: 16px !important; font-stretch: condensed; line-height: 35px;"  data-type="child" data-index="' + index + '">' + item.Name +
              '      </div>                                                                                      ' +
                '          <img src="' + imgSrc2 + '" class="add-passenger-details" data-type="child" data-index="' + index + '" style="width: 32px;"/>     ' +
                '      <div class="col-10">                                                                        ' +
              '          <img src="img/users-icons.svg" class="go-to-fav" data-type="child" data-index="' + index + '" style="width: 32px;"/>                                                          ' +
              '      </div>                                                                                      ' +
                  '      <div class="col-10 ">                                                                       ' +
                  '          <img src="img/search-icons.svg" class="search-passenger-details" data-type="child" data-index="' + index + '" style="width: 32px;"/>                                                            ' +
              '      </div>                                                                                      ' +
              '  </div> ';
        }
    });
...
function fillInfantsList(array)
{
    var infa_list = myApp.virtualList('.infa-list', {
        ...
        renderItem: function (index, item)
        {
          ...
          '          <img src="' + imgSrc + '"  style="width: 15px; margin: 25%;padding-top: 5px;"/>                                                    ' +
              '      </div>                                                                                      ' +
          '      <div class="adult-text col-50 passenger_name add-passenger-details" style="font-weight: 300; font-size: 16px !important; font-stretch: condensed; line-height: 35px;"  data-type="infant" data-index="' + index + '">' + item.Name +
              '      </div>                                                                                      ' +
                '          <img src="' + imgSrc2 + '" class="add-passenger-details" data-type="infant" data-index="' + index + '" style="width: 32px;"/>' +
                '      <div class="col-10">                                                                        ' +
              '          <img src="img/users-icons.svg" class="go-to-fav" data-type="infant" data-index="' + index + '" style="width: 32px;"/>                                                          ' +
              '      </div>                                                                                      ' +

                '      <div class="col-10 " >                                                                       ' +
          '          <img src="img/search-icons.svg" class="search-passenger-details" data-type="infant" data-index="' + index + '" style ="width: 32px;" />                                                            ' +
              '      </div>                                                                                      ' +
              '  </div> ';
        }
    });
